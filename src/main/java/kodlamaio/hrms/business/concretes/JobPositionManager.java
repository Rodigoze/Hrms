...
public class JobPositionManager implements JobPositionService {
	...
	@Override
	public DataResult<List<JobPosition>> getByJobTitle(String jobTitle) {
		
		return new SuccessDataResult<List<JobPosition>>(this.jobPositionDao.getByJobTitle(jobTitle));
	}
